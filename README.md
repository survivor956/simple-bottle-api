...
5. Add C:\Python27\Scripts path to environment variable
6. ` git clone git@github.com:survivor956/simple-bottle-api.git`
7. `sudo yum install python-pip`
8. In cmd `pip install fabric fabtools`
9. Open Git Bash and `cd bottle-mongo-api`
8. 1. If you want to reset:
    `vagrant box remove workshop` 
    `rm -rf .vagrant`
9. `vagrant up`
10. run `fab bootstrap_vagrant`
